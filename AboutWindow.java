...
public class AboutWindow extends JFrame {
	...
	private AboutWindow() {
		...
		JLabel lblLink = new JLabel("http://currencyconverter.com");
		...
		lblLink.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    Desktop.getDesktop().browse(new URI("http://currencyconverter.com"));
                } catch (Exception ex) {
                	ex.printStackTrace();
                }
            }
		...
		JLabel lblLicenceMit = new JLabel("Licensed Version");
